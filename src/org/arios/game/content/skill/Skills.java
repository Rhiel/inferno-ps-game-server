...
public final class Skills {
	...
	if (entity instanceof Player) {
	    p = (Player) entity;
	    //A boost for combat skills under level 20.
	    if(entity instanceof Player && !this.hasLevel(slot, 20) && isCombat(slot)){
		mod *= 1.50;
	    }
	    /*DXP event -- does not stack with personal ::shop double xp*/
	    if(GlobalEvents.DOUBLE_EXPERIENCE.isEventRunning() && p.getExperienceMod() == 0.0){
		mod *= 2;
	    }
