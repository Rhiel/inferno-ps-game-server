...
public final class PlayerPortalDialogue extends DialoguePlugin {
	...
	DXP("Double experience (2 hours)", 10) {
		...
		player.getPacketDispatch().sendMessage("You have activated double experience. To see how much time you have remaining,");
		player.getPacketDispatch().sendMessage("type ::shop again and attempt to activate double experience again.");
	    }
