...
public abstract class EmoteClueScroll extends ClueScrollPlugin {
     ...
     * The commening emote.
     */
    private final Emote commenceEmote;
     ...
     */
    public EmoteClueScroll(String name, int clueId, ClueLevel level, Emote emote, Emote commenceEmote, int[][] equipment, final String clue, ZoneBorders... borders) {
	...
	final Emote emote = Emote.forId(buttonId);
	if (emote == null) {
	    return false;
	}
	if (emote == this.emote) {
