...
public final class AnimalMagnetism extends Quest {
	...
	player.getPacketDispatch().sendString("1000 XP in each of Crafting,", 277, 8);
	player.getPacketDispatch().sendString("Fletching and Slayer", 277, 9);
	player.getPacketDispatch().sendString("2500 Wooducuting XP", 277, 10);
	player.getPacketDispatch().sendString("1 Quest Point", 277, 11);
	player.getPacketDispatch().sendString("Ava's device", 277, 12);
	player.getPacketDispatch().sendString("You have completed Animal Magnetism Quest!", 277, 2);
	player.getPacketDispatch().sendItemZoomOnInterface(item.getId(), 235, 277, 3);
