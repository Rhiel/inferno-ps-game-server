...
public final class LevelUp {
     ...
     */
    private static final int[] SKILL_INTERFACES = { 158, 161, 175, 167, 171, 170, 168, 159, 177, 165, 164, 163, 160, 174, 169, 166, 157, 176, 173, 162, 172, 172, 395, 630 };
	...
	player.getPacketDispatch().sendString("Your " + Skills.SKILL_NAME[slot] + " level is now " + player.getSkills().getStaticLevel(slot) + ".", interfaceId, 1);
