...
public final class WeaponInterface extends Component {
	...
	public void updateInterface() {
		...
		player.getConfigManager().set(843, current.getConfig());
	...
	public void openAutocastSelect() {
		...
		component.getDefinition().setContext(new InterfaceContext(player, player.getInterfaceManager().getWindowsPane(), InterfaceManager.ATTACK_SLOT, InterfaceManager.ATTACK_SLOT_FULL, id, false));
