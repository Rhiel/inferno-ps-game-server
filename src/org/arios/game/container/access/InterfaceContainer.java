...
public class InterfaceContainer {
    ...
    /**
     * Generates a container/array of items in an interface positioned on the child index.
     ...
     * @param childIndex, the child index of the interface where we display the items at.
    ...
    /**
     * Generates a script argument type string for the client
     * (note: everything but a "s" is integer for the run script packet)
    ...
    /**
     * Method to generate the send items for the client with a specified location for the items.
