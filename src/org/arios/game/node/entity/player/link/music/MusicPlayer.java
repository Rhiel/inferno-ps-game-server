...
public final class MusicPlayer implements SavingModule {
    ...
    public void init() {
        ...
        if (!hasAirGuitar() && player.getEmotes().getUnlocked()[EmoteData.AIR_GUITAR]) {
    ...
    public void play(MusicEntry entry) {
        ...
        PacketRepository.send(StringPacket.class, new StringContext(player, entry.getName(), 239, 5));
