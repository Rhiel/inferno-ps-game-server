...
public final class ShoppingPlugin extends ComponentPlugin {
	...
	case 203:
		...
		if (amount == -1) {
		    player.setAttribute("runscript", getRunScript(viewer, slot));
     ...
     * @param slot the slot.
     */
    private RunScript getRunScript(final ShopViewer viewer, final int slot) {
	...
	return opcode == 205 ? 1 : opcode == 127 ? 5 : opcode == 211 ? 10 : -1;
    }
}
