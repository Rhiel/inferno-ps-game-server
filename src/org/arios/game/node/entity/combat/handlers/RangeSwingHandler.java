...
public class RangeSwingHandler extends CombatSwingHandler {
    ...
    public InteractionType canSwing(Entity entity, Entity victim) {
        ...
        int distance = 7;
        if (entity instanceof Player && (((WeaponInterface) entity.getExtension(WeaponInterface.class)).getWeaponInterface() == WeaponInterface.WeaponInterfaces.MUD_PIE || ((WeaponInterface) entity.getExtension(WeaponInterface.class)).getWeaponInterface() == WeaponInterface.WeaponInterfaces.THROWN_WEAPONS)) {
            distance -= 2;
        }
    ...
    public int swing(Entity entity, Entity victim, BattleState state) {
        ...
        int remainingLife = victim.getSkills().getLifepoints() - hit;
        ...
        if (victim instanceof NPC && remainingLife < 1) { // only applies for NPCs
            entity.getProperties().getCombatPulse().stopForDeath(1);
        }
