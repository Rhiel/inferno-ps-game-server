...
public final class GardenerPlugin extends OptionHandler {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		break;
	    case 20:
		npc("There are four main Farming areas - Elstan looks", "after an area south of Falador, Dantaera has one to the", "north of Catherby, Krage has one near Ardougne, and", "Lyra looks after a place in north Morytania.");
		stage = 21;
		break;
	    case 21:
		options("Would you look after my crops for me?", "Can you give me any farming advice?", "Can you sell me something?", "That's all thanks.");
		...
		break;
	    case 30:
		npc("That depends on wether I have it to sell. What is it", "that you're looking for?");
		stage = 31;
		break;
	    case 31:
	...
	private void purchase(ShopItem item) {
		...
		npc(StringUtils.formatDisplayName(item.getItem().getName()) + ", eh? I might have " + type + " put aside for myself.", "Tell you what, I'll sell you " + type + " " + item.getItem().getName().toLowerCase() + " for " + item.getPrice().getAmount() + "GP if", "you like.");
	    }
	    stage = 35;
	}
