...
public class ObjectDefinition extends Definition<GameObject> {
    ...
    public static void main(String... args) throws Throwable {
        ...
        // return;
        // }
        ObjectDefinition def = ObjectDefinition.forId(15313);
    ...
    public static ObjectDefinition parseDefinition(int objectId, ByteBuffer buffer) {
        ...
        while (true) {
            ...
            if (opcode == 1 || opcode == 5) {
                ...
                def.anInt3892 = (buffer.get() & 0xFF);
            } else if (opcode == 29) {
                def.anInt3878 = buffer.get();
            } else if (opcode == 39) {
                def.anInt3840 = buffer.get() * 25;
                ...
                for (int i = 0; i < length; i++) {
                    def.originalColors[i] = (short) (buffer.getShort() & 0xff);
                    def.modifiedColors[i] = (short) (buffer.getShort() & 0xff);
                }
            } else if (opcode == 41) {
                int length = buffer.get() & 0xFF;
                ...
                for (int i = 0; i < length; i++) {
                    def.aShortArray3920[i] = (short) (buffer.getShort() & 0xff);
                    def.aShortArray3919[i] = (short) (buffer.getShort() & 0xff);
                }
            } else if (opcode == 62) {
                ...
                int l = (short) (buffer.getShort() & 0xff);
            } else if (opcode == 69) {
                def.walkingFlag = buffer.get() & 0xFF;
            } else if (opcode == 70) {
                def.anInt3883 = buffer.getShort();
            } else if (opcode == 71) {
                def.anInt3889 = buffer.getShort();
            } else if (opcode == 72) {
                def.anInt3915 = buffer.getShort();
            } else if (opcode == 73) {
                def.secondBool = true;
            } else if (opcode == 74) {
                def.notClipped = true;
