...
public enum CanoeStation {
    LUMBRIDGE(12163, new int[] { 32, 11 }, Location.create(3240, 3242, 0), new Location(3241, 3235, 0)), CHAMPIONS_GUILD(12164, new int[] { 33, 13 }, Location.create(3199, 3344, 0), new Location(3200, 3341, 0)), BARBARIAN_VILLAGE(12165, new int[] { 34, 15 }, Location.create(3109, 3415, 0), new Location(3110, 3409, 0)), EDGEVILLE(12166, new int[] { 39, 38 }, Location.create(3132, 3510, 0), new Location(3130, 3508, 0)), WILDERNESS(-1, new int[] { 35 }, Location.create(3139, 3796, 0), null);
