 ...
 */
public enum Gliders {
    TA_QUIR_PRIW(27, Location.create(2465, 3501, 3), 9, 3809), SINDARPOS(28, Location.create(2848, 3497, 0), 1, 3810), LEMANTO_ADRA(29, Location.create(3321, 3427, 0), 10, -1), KAR_HEWO(30, Location.create(3278, 3212, 0), 4, 3812), LEMANTOLLY_UNDRI(31, Location.create(2544, 2970, 0), 10, 3813), GANDIUS(26, Location.create(2894, 2730, 0), 8, 3811);
