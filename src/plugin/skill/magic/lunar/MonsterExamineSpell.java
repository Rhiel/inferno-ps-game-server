...
public final class MonsterExamineSpell extends MagicSpell {
	...
	public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
		SpellBook.LUNAR.register(98, this);
		return this;
	}
	...
	public boolean cast(Entity entity, Node target) {
		...
		player.face(npc);
		//player.getAudioManager().send("spell_monster_examine");
		COMPONENT.getDefinition().setContext(new InterfaceContext(player, player.getInterfaceManager().getWindowsPane(), 126, 126, 522, false));
