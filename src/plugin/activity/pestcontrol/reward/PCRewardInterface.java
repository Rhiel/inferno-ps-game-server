...
public final class PCRewardInterface extends ComponentPlugin {
     ...
     */
    public static final int[] SKILL_HEADER = new int[] { 12, 14, 13, 17, 15, 18, 16 };
	...
	sendString(player, "Points: " + player.getSavedData().getActivityData().getPestPoints(), 110);
	clear(player);
	...
	sendString(player, reward.getName(), 109);
     ...
     */
    public enum Reward {
	ATTACK(Skills.ATTACK, new int[] { 12, 36, 51, 58 }), STRENGTH(Skills.STRENGTH, new int[] { 13, 37, 52, 59 }), DEFENCE(Skills.DEFENCE, new int[] { 14, 38, 53, 60 }), RANGE(Skills.RANGE, new int[] { 15, 39, 54, 61 }), MAGIC(Skills.MAGIC, new int[] { 16, 40, 55, 62 }), HITPOINTS(Skills.HITPOINTS, new int[] { 17, 41, 56, 63 }), PRAYER(Skills.PRAYER, new int[] { 18, 42, 57, 64 }), HERB_PACK("Herb Pack", 30, new Item[] { Herbs.HARRALANDER.getHerb(), Herbs.RANARR.getHerb(), Herbs.TOADFLAX.getHerb(), Herbs.IRIT.getHerb(), Herbs.AVANTOE.getHerb(), Herbs.KWUARM.getHerb(), Herbs.GUAM.getHerb(), Herbs.MARRENTILL.getHerb() }, new int[] { 34, 47 }) {
	    @Override
	...
	MINERAL_PACK("Mineral Pack", 15, new Item[] { new Item(453), new Item(440) }, new int[] { 49, 48 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
	...
	SEED_PACK("Seed Pack", 15, new Item[] { new Item(5320), new Item(5322), new Item(5100) }, new int[] { 35, 50 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
	...
	VOID_MACE("Void Knight Mace", 250, new Item[] { new Item(8841) }, new int[] { 30, 43 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
		return hasVoidSkills(player);
	    }
	},
	VOID_TOP("Void Knight Top", 250, new Item[] { new Item(8839) }, new int[] { 31, 44 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
		return hasVoidSkills(player);
	    }
	},
	VOID_ROBES("Void Knight Robes", 250, new Item[] { new Item(8840) }, new int[] { 32, 45 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
		return hasVoidSkills(player);
	    }
	},
	VOID_GLOVES("Void Knight Gloves", 150, new Item[] { new Item(8842) }, new int[] { 33, 46 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
		return hasVoidSkills(player);
	    }
	},
	VOID_MAGE_HELM("Void Knight Mage Helm", 200, new Item[] { new Item(11663) }, new int[] { 65, 69 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
		return hasVoidSkills(player);
	    }
	},
	VOID_RANGER_HELM("Void Knight Ranger Helm", 200, new Item[] { new Item(11664) }, new int[] { 66, 70 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
		return hasVoidSkills(player);
	    }
	},
	VOID_MELEE_HELM("Void Knight Melee Helm", 200, new Item[] { new Item(11665) }, new int[] { 67, 71 }) {
	    @Override
	    public boolean checkItemRequirement(final Player player, final int option) {
		return hasVoidSkills(player);
	    }
	},
	VOID_KNIGHT_SEAL("Void Knight Seal", 10, new Item[] { new Item(11666) }, new int[] { 68, 72 }), SPINNER_CHARM("Spinner Charm", new Item(12166), 73, 77, 78, 79), RAVAGER_CHARM("Ravager Charm", new Item(12164), 74, 86, 82, 83), TORCHER_CHARM("Torcher Charm", new Item(12167), 76, 88, 80, 81), SHIFTER_CHAR("Shifter Charm", new Item(12165), 75, 87, 84, 85);
