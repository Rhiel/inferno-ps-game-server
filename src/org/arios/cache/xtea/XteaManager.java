...
public class XteaManager {
    ...
    public static void loadUnpacked() throws IOException {
        File directory = new File("./data/xtea/unpacked/");
        DataOutputStream output = new DataOutputStream(new FileOutputStream("./data/xtea/packedKeys.bin"));
